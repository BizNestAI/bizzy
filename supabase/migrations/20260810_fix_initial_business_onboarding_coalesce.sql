-- Fix invalid schema qualification of COALESCE in the initial onboarding RPC.
--
-- COALESCE is PostgreSQL expression syntax, not a pg_catalog function. The
-- previous ambiguity fix correctly qualified real built-ins such as BTRIM/LOWER,
-- but schema-qualifying that syntax fails at runtime with function-not-found.
