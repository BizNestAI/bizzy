...
revoke all on function public.get_bookkeeping_transactions_bounded(uuid, text, text, date, integer, integer) from public, anon, authenticated;
revoke all on function public.count_bookkeeping_transactions_bounded(uuid, text, text, date) from public, anon, authenticated;
...
grant execute on function public.get_bookkeeping_transactions_bounded(uuid, text, text, date, integer, integer) to service_role;
grant execute on function public.count_bookkeeping_transactions_bounded(uuid, text, text, date) to service_role;
