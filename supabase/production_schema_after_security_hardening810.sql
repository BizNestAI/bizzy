...
CREATE OR REPLACE FUNCTION "public"."bizzi_current_user_can_manage_business"("p_business_id" "uuid") RETURNS boolean
...
ALTER FUNCTION "public"."bizzi_current_user_can_manage_business"("p_business_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."bizzi_current_user_is_business_member"("p_business_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'pg_catalog', 'public'
    AS $$
  SELECT
...
ALTER FUNCTION "public"."bizzi_current_user_is_business_member"("p_business_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_initial_business_for_user"("p_user_id" "uuid", "p_email" "text", "p_business_name" "text", "p_industry" "text", "p_team_size" integer, "p_state" "text", "p_services_offered" "text", "p_annual_revenue" "text" DEFAULT NULL::"text", "p_billing_model" "text" DEFAULT NULL::"text", "p_founded_year" integer DEFAULT NULL::integer, "p_top_challenge" "text" DEFAULT NULL::"text") RETURNS TABLE("id" "uuid", "user_id" "uuid", "business_name" "text", "industry" "text", "team_size" integer, "annual_revenue" "text", "state" "text", "services_offered" "text", "billing_model" "text", "founded_year" integer, "top_challenge" "text", "membership_role" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_initial_business_for_user"("p_user_id" "uuid", "p_email" "text", "p_business_name" "text", "p_industry" "text", "p_team_size" integer, "p_state" "text", "p_services_offered" "text", "p_annual_revenue" "text", "p_billing_model" "text", "p_founded_year" integer, "p_top_challenge" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."prevent_business_profile_identity_reassignment"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."prevent_business_profile_identity_reassignment"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."prevent_notification_tenant_reassignment"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."prevent_notification_tenant_reassignment"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."prevent_user_business_link_identity_reassignment"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."prevent_user_business_link_identity_reassignment"() OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."ar_aging" WITH ("security_invoker"='true') AS
 SELECT "business_id",
    "id" AS "invoice_id",
...
CREATE OR REPLACE VIEW "public"."ar_aging_v2" WITH ("security_invoker"='true') AS
 SELECT "business_id",
    "qbo_invoice_id",
...
CREATE OR REPLACE VIEW "public"."billing_customer_overview" WITH ("security_invoker"='true') AS
 SELECT "business_id",
    "business_name",
...
CREATE OR REPLACE VIEW "public"."expense_categories" WITH ("security_invoker"='true') AS
 SELECT "business_id",
...
CREATE OR REPLACE VIEW "public"."insights_history" WITH ("security_invoker"='true') AS
 SELECT "i"."id",
    "i"."user_id",
    "i"."business_id",
    "i"."module",
...
CREATE OR REPLACE VIEW "public"."jobs_profitability" WITH ("security_invoker"='true') AS
...
CREATE OR REPLACE VIEW "public"."positions_view" WITH ("security_invoker"='true') AS
 SELECT "p"."user_id",
...
CREATE OR REPLACE TRIGGER "trg_business_profiles_identity_immutable" BEFORE UPDATE OF "id", "user_id" ON "public"."business_profiles" FOR EACH ROW EXECUTE FUNCTION "public"."prevent_business_profile_identity_reassignment"();
...
CREATE OR REPLACE TRIGGER "trg_notifications_tenant_immutable" BEFORE UPDATE OF "user_id", "business_id" ON "public"."notifications" FOR EACH ROW EXECUTE FUNCTION "public"."prevent_notification_tenant_reassignment"();
...
CREATE OR REPLACE TRIGGER "trg_user_business_link_identity_immutable" BEFORE UPDATE OF "id", "user_id", "business_id", "role" ON "public"."user_business_link" FOR EACH ROW EXECUTE FUNCTION "public"."prevent_user_business_link_identity_reassignment"();
...
CREATE POLICY "ar_open_items_member_select" ON "public"."ar_open_items" FOR SELECT TO "authenticated" USING ("public"."bizzi_current_user_is_business_member"("business_id"));
...
CREATE POLICY "bank_transactions_member_select" ON "public"."bank_transactions" FOR SELECT TO "authenticated" USING ("public"."bizzi_current_user_is_business_member"("business_id"));
...
CREATE POLICY "bizzy_memory_own_user_select" ON "public"."bizzy_memory" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "business_profiles_manager_update" ON "public"."business_profiles" FOR UPDATE TO "authenticated" USING ("public"."bizzi_current_user_can_manage_business"("id")) WITH CHECK ("public"."bizzi_current_user_can_manage_business"("id"));



CREATE POLICY "business_profiles_member_select" ON "public"."business_profiles" FOR SELECT TO "authenticated" USING ("public"."bizzi_current_user_is_business_member"("id"));
...
CREATE POLICY "expense_totals_monthly_member_select" ON "public"."expense_totals_monthly" FOR SELECT TO "authenticated" USING ("public"."bizzi_current_user_is_business_member"("business_id"));
...
CREATE POLICY "financial_metrics_member_select" ON "public"."financial_metrics" FOR SELECT TO "authenticated" USING ("public"."bizzi_current_user_is_business_member"("business_id"));
...
CREATE POLICY "gpt_usage_own_user_select" ON "public"."gpt_usage" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "insight_preferences_own_insert" ON "public"."insight_preferences" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));



CREATE POLICY "insight_preferences_own_select" ON "public"."insight_preferences" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "insight_preferences_own_update" ON "public"."insight_preferences" FOR UPDATE TO "authenticated" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "insights_member_select" ON "public"."insights" FOR SELECT TO "authenticated" USING ("public"."bizzi_current_user_is_business_member"("business_id"));
...
CREATE POLICY "invoices_member_select" ON "public"."invoices" FOR SELECT TO "authenticated" USING ("public"."bizzi_current_user_is_business_member"("business_id"));
...
CREATE POLICY "notifications_own_member_insert" ON "public"."notifications" FOR INSERT TO "authenticated" WITH CHECK ((("user_id" = "auth"."uid"()) AND (("business_id" IS NULL) OR "public"."bizzi_current_user_is_business_member"("business_id"))));



CREATE POLICY "notifications_own_member_select" ON "public"."notifications" FOR SELECT TO "authenticated" USING ((("user_id" = "auth"."uid"()) AND (("business_id" IS NULL) OR "public"."bizzi_current_user_is_business_member"("business_id"))));



CREATE POLICY "notifications_own_member_update" ON "public"."notifications" FOR UPDATE TO "authenticated" USING ((("user_id" = "auth"."uid"()) AND (("business_id" IS NULL) OR "public"."bizzi_current_user_is_business_member"("business_id")))) WITH CHECK ((("user_id" = "auth"."uid"()) AND (("business_id" IS NULL) OR "public"."bizzi_current_user_is_business_member"("business_id"))));
...
CREATE POLICY "tax_deadlines_global_or_member_select" ON "public"."tax_deadlines" FOR SELECT TO "authenticated" USING ((("business_id" IS NULL) OR "public"."bizzi_current_user_is_business_member"("business_id")));
...
CREATE POLICY "tax_snapshots_member_select" ON "public"."tax_snapshots" FOR SELECT TO "authenticated" USING ("public"."bizzi_current_user_is_business_member"("business_id"));
...
CREATE POLICY "tax_state_rates_authenticated_select" ON "public"."tax_state_rates" FOR SELECT TO "authenticated" USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "user_business_link_self_or_manager_select" ON "public"."user_business_link" FOR SELECT TO "authenticated" USING ((("user_id" = "auth"."uid"()) OR "public"."bizzi_current_user_can_manage_business"("business_id")));
...
REVOKE ALL ON FUNCTION "public"."acquire_posting_lock"("p_business_id" "uuid", "p_transaction_id" "text", "p_now_iso" timestamp with time zone, "p_lock_stale_seconds" integer, "p_idempotency_key" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."acquire_posting_lock"("p_business_id" "uuid", "p_transaction_id" "uuid", "p_now_iso" timestamp with time zone, "p_lock_stale_seconds" integer, "p_idempotency_key" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."billing_effective_bool"("p_legacy_value" boolean, "p_live_value" boolean, "p_test_value" boolean) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."billing_effective_status"("p_legacy_status" "text", "p_live_status" "text", "p_test_status" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."billing_effective_text"("p_legacy_value" "text", "p_live_value" "text", "p_test_value" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."billing_effective_timestamptz"("p_legacy_value" timestamp with time zone, "p_live_value" timestamp with time zone, "p_test_value" timestamp with time zone) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."bizzi_current_user_can_manage_business"("p_business_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."bizzi_current_user_can_manage_business"("p_business_id" "uuid") TO "service_role";
GRANT ALL ON FUNCTION "public"."bizzi_current_user_can_manage_business"("p_business_id" "uuid") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."bizzi_current_user_is_business_member"("p_business_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."bizzi_current_user_is_business_member"("p_business_id" "uuid") TO "service_role";
GRANT ALL ON FUNCTION "public"."bizzi_current_user_is_business_member"("p_business_id" "uuid") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."claim_contractor_cfo_insight_run"("p_run_key" "text", "p_scheduled_for" timestamp with time zone, "p_lock_owner" "text", "p_lock_ttl_seconds" integer) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."claim_scheduled_job_lock"("p_job_key" "text", "p_scheduled_for" timestamp with time zone, "p_locked_by" "text", "p_lock_ttl_seconds" integer, "p_metadata" "jsonb") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."claim_tax_recalculation_requests"("p_worker_id" "text", "p_batch_size" integer, "p_now" timestamp with time zone) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."compute_days_overdue"("due_date" "date") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."compute_days_overdue"("due_date" "date") TO "service_role";



REVOKE ALL ON FUNCTION "public"."create_initial_business_for_user"("p_user_id" "uuid", "p_email" "text", "p_business_name" "text", "p_industry" "text", "p_team_size" integer, "p_state" "text", "p_services_offered" "text", "p_annual_revenue" "text", "p_billing_model" "text", "p_founded_year" integer, "p_top_challenge" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."create_initial_business_for_user"("p_user_id" "uuid", "p_email" "text", "p_business_name" "text", "p_industry" "text", "p_team_size" integer, "p_state" "text", "p_services_offered" "text", "p_annual_revenue" "text", "p_billing_model" "text", "p_founded_year" integer, "p_top_challenge" "text") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_tax_deduction_transaction_drilldown"("p_business_id" "uuid", "p_tax_year" integer, "p_as_of_date" "date", "p_tax_category" "text", "p_month" "text", "p_deductibility_status" "text", "p_classification_status" "text", "p_confidence_level" "text", "p_qbo_account_id" "text", "p_merchant" "text", "p_search" "text", "p_min_amount" numeric, "p_max_amount" numeric, "p_sort" "text", "p_limit" integer, "p_offset" integer) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."is_member"("p_user" "uuid", "p_business" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."is_member"("p_user" "uuid", "p_business" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."match_bizzy_memory"("user_uuid" "uuid", "query_embedding" "public"."vector", "match_threshold" double precision, "match_count" integer, "tag_filter" "text"[]) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."match_memories"("query_embedding" "public"."vector", "match_user_id" "uuid", "match_count" integer) FROM PUBLIC;
...
GRANT ALL ON FUNCTION "public"."prevent_business_profile_identity_reassignment"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."prevent_notification_tenant_reassignment"() TO "service_role";



REVOKE ALL ON FUNCTION "public"."prevent_user_business_link_identity_reassignment"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."prevent_user_business_link_identity_reassignment"() TO "service_role";



REVOKE ALL ON FUNCTION "public"."recalc_thread_last_message"("p_thread" "uuid") FROM PUBLIC;
