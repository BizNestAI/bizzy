...
function shouldDispatchTaxClassification(changeType) {
  return [
    ...
    TAX_CHANGE_TYPES.QBO_TRANSACTION_UPDATED,
    TAX_CHANGE_TYPES.QBO_TRANSACTION_VOIDED,
    TAX_CHANGE_TYPES.QBO_TRANSACTION_DELETED,
    TAX_CHANGE_TYPES.QBO_TRANSACTION_REVERSED,
...
export function mapChangeTypeToRecalculationEvent(changeType) {
  const map = {
    ...
    [TAX_CHANGE_TYPES.QBO_TRANSACTION_DELETED]: TAX_RECALCULATION_EVENT_TYPES.QBO_TRANSACTION_VOIDED,
    [TAX_CHANGE_TYPES.QBO_TRANSACTION_REVERSED]: TAX_RECALCULATION_EVENT_TYPES.QBO_TRANSACTION_POSTED,
