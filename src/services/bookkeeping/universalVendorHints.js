...
UNIVERSAL_VENDOR_HINTS.push(
  ...
  },
  {
    ...
    intents: ["payment_processing_fee"],
    primary_intent: "payment_processing_fee",
    confidence: "high",
    notes: "QuickBooks/Intuit card or ACH processing fee",
  },
  {
    key: "intuit_transaction_fee_full",
    match: { type: "contains", value: "transaction fee intuit" },
    canonical: "Intuit Transaction Fee",
    intents: ["payment_processing_fee"],
    primary_intent: "payment_processing_fee",
    confidence: "high",
  ...
  {
    key: "intuit_payments_fee",
    match: { type: "contains", value: "intuit payments fee" },
    canonical: "Intuit Transaction Fee",
    intents: ["payment_processing_fee"],
    primary_intent: "payment_processing_fee",
    confidence: "high",
  ...
  {
    key: "intuit_payment_fee",
    match: { type: "contains", value: "intuit payment fee" },
    canonical: "Intuit Transaction Fee",
    intents: ["payment_processing_fee"],
    primary_intent: "payment_processing_fee",
    confidence: "high",
  ...
  {
    key: "quickbooks_payments_fee",
    match: { type: "contains", value: "quickbooks payments fee" },
    canonical: "Intuit Transaction Fee",
    intents: ["payment_processing_fee"],
    primary_intent: "payment_processing_fee",
    confidence: "high",
  ...
  {
    key: "quickbooks_payment_fee",
    match: { type: "contains", value: "quickbooks payment fee" },
    canonical: "Intuit Transaction Fee",
    intents: ["payment_processing_fee"],
    primary_intent: "payment_processing_fee",
    confidence: "high",
