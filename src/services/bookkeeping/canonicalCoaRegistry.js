...
const canonicalAccounts = [
  ...
  account("credit_card_interest", "Credit Card Interest", "Expense", "InterestPaid", AUTO_CREATE_ALLOWED, false, "Credit-card interest and finance charges.", 165),
...
const intentMappings = {
  ...
  payment_processing_fee: "payment_processing_fees",
...
const approvedEquivalents = {
  ...
  credit_card_interest: ["Credit Card Interest", "Interest Expense", "Finance Charges"],
