...
const INTENT_KEYWORDS = {
  ...
  supplies_materials: ["supplies and materials", "supplies materials", "materials", "supplies", "business supplies", "job materials"],
...
const RELATED_INTENT_KEYS = {
  ...
  materials: ["tools"],
  supplies_materials: ["materials", "supplies", "office_supplies"],
