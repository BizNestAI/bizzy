 ...
 * body: { user_id, business_id, year, month, forceRefresh?: boolean }
...
router.post("/pdf", async (req, res) => {
  try {
    ...
    console.log("[pnl/pdf] HIT", { business_id, year, month, forceRefresh, filePath, body });

    const out = await ensurePnLPdf({ business_id, year, month, forceRefresh });
