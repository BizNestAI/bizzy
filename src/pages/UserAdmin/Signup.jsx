...
import { Eye, EyeOff, ArrowRight, CheckCircle2, Mail, Lock, AlertCircle } from "lucide-react";
              ...
              >
                <div className="flex gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="text-[13px] font-semibold leading-5 text-white/[0.92]">Account setup paused</div>
